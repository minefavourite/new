...
<script>
    $(function () {
        ...
        //点赞操作
        $(".btn-ding").click(function () {

            var tid = $(this).data("tid");
            $.get("/travel/travelThumbup", {tid:tid}, function (data) {
                if(data.success){
                    $(".post-ding").html(data.data.thumbsupnum);
                    popup("顶成功啦"); //
                    ...
                    <div class="post-list">
                        <ul>
                            ...
                            <li class="post-item clearfix">
                                ...
                                <div class="post-ding"><span id="topvote11710590">${t.thumbsupnum!}</span><a class="btn-ding" href="javascript:;" data-japp="articleding" data-tid="${t.id}" data-vote="2067">顶</a></div>
