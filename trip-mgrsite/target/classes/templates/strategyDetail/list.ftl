    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".changeStateBtn").click(function () {
                ...
                $.get("/strategyDetail/changeState", {state:state, id:id}, function (data) {
                    if(data.success){
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <form class="form-inline" id="searchForm" action="/strategyDetail/list" method="post">
                ...
                <a href="/strategyDetail/input" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span>  添加</a>
            </form>
                   ...
                   <tr>
                       ...
                       <td>
                           ...
                           <a href="javascript:;" class="btn btn-danger btn-xs deleteBtn"
                              data-url="/strategyDetail/delete?id=${entity.id}">
