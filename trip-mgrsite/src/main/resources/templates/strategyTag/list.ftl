    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".hotBtn").click(function () {
                ...
                var id = $(this).data("id");
                $.get("/strategyTag/changeHotValue", {hot:hot, id:id}, function (data) {
                    if(data.success){
                        window.location.reload();
                    }else{
                        $.messager.alert("温馨提示", data.msg);
...
-->
                           <a href="javascript:;" class="btn btn-danger btn-xs deleteBtn"
                              data-url="/strategyTag/delete?id=${entity.id}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">攻略标签添加/编辑</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" action="/strategyTag/saveOrUpdate" method="post" id="editForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="name" name="name"  placeholder="请输入攻略标签名称">
                        </div>
                    </div>
