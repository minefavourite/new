                   ...
                   <tr>
                       ...
                       <td>
                           ...
                           <a href="javascript:;" class="btn btn-danger btn-xs deleteBtn"
                              data-url="/travelCommend/delete?id=${entity.id}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">游记推荐添加/编辑</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" action="/travelCommend/saveOrUpdate" method="post" id="editForm">
                    <input type="hidden" value="" name="id">
                    <div class="form-group">
                        <label  class="col-sm-3 control-label">标题：</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="title" name="title"  placeholder="请输入游记推荐标题">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="subTitle" name="subTitle"  placeholder="请输入游记推荐副标题">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label  class="col-sm-3 control-label">关联游记明细：</label>
                        <div class="col-sm-6">
